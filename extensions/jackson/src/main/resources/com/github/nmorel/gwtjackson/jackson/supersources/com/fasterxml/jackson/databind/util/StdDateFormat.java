...
public class StdDateFormat
    ...
    public Date parse(String dateStr) throws ParseException {
        ...
        sb.append('"');
        throw new ParseException(StringUtil.format(
                "Can not parse date \"%s\": not compatible with any of standard forms (%s)",
    ...
    protected Date parseAsISO8601(String dateStr, ParsePosition pos, boolean throwErrors)
        ...
        if (dt == null) {
            throw new ParseException(StringUtil.format(
                    "Can not parse date \"%s\": while it seems to fit format '%s', parsing fails (leniency? %s)",
