...
public class SimpleType // note: until 2.6 was final
    ...
    public static SimpleType construct(Class<?> cls) {
         ...
         */
        if (ClassUtils.isAssignableFrom(Map.class, cls)) {
            throw new IllegalArgumentException("Can not construct SimpleType for a Map (class: " + cls.getName() + ")");
        }
        if (ClassUtils.isAssignableFrom(Collection.class, cls)) {
    ...
    protected JavaType _narrow(Class<?> subclass) {
        ...
        // TODO: fix in 2.9
        if (!ClassUtils.isAssignableFrom(_class, subclass)) {
            /*
        ...
        if ((next != null) && ClassUtils.isAssignableFrom(_class, next)) {
